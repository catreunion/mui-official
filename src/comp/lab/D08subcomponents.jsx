  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <YearPicker date={date} isDateDisabled={() => false} minDate={minDate} maxDate={maxDate} onChange={newDate => setDate(newDate)} />
        </Grid>
      </Grid>
...
export default D08subcomponents
