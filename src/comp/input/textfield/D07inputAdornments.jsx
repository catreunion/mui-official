    ...
    <Box sx={{ display: "flex", flexWrap: "wrap" }}>
      ...
      <div>
        ...
        <FormControl fullWidth sx={{ m: 1 }} variant="filled">
          ...
          <FilledInput id="filled-adornment-amount" value={values.amount} onChange={handleChange("amount")} startAdornment={<InputAdornment position="start">$</InputAdornment>} />
        </FormControl>
      </div>
...
export default D07InputAdornments
